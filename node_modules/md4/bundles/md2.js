/**
  * @license Md2 v0.0.33
  * Copyright (c) 2017 harryy, Inc. http://code.harryyinfo.com/md2/
  * License: MIT
  */
import { ApplicationRef, Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ComponentFactoryResolver, ContentChildren, Directive, ElementRef, EventEmitter, HostBinding, Inject, Injectable, InjectionToken, Injector, Input, NgModule, NgZone, Optional, Output, Pipe, QueryList, Renderer2, Self, SkipSelf, TemplateRef, ViewChild, ViewContainerRef, ViewEncapsulation, forwardRef, isDevMode } from '@angular/core';
...
import { FormsModule, NG_VALIDATORS, NG_VALUE_ACCESSOR, NgControl, Validators } from '@angular/forms';
...
Md2AutocompleteModule = __decorate$37([
    NgModule({
...
__decorate$42([
    Input(),
    __metadata$24("design:type", Date)
...
Md2Calendar = __decorate$42([
    ...
    __metadata$24("design:paramtypes", [ElementRef, NgZone,
        DateLocale, DateUtil])
], Md2Calendar);
...
__decorate$41([
    Input(),
    __metadata$23("design:type", Date)
...
__decorate$41([
    Input(),
    __metadata$23("design:type", Date),
    __metadata$23("design:paramtypes", [Date])
...
__decorate$41([
    ...
    __metadata$23("design:paramtypes", [Function])
...
__decorate$41([
    Output(),
    __metadata$23("design:type", Object)
], Md2Datepicker.prototype, "monthChange", void 0);
Md2Datepicker = __decorate$41([
    Component({selector: 'md2-datepicker',
        template: "<div class=\"md2-datepicker-trigger\"><div class=\"md2-datepicker-input\" [class.md2-datepicker-input-focused]=\"_inputFocused\"><input #input type=\"text\" class=\"md2-datepicker-value\" [tabindex]=\"tabindex\" [disabled]=\"disabled\" autocomplete=\"off\" [value]=\"_inputValue\" (change)=\"$event.stopPropagation()\" (click)=\"_handleFocus()\" (focus)=\"_handleFocus()\" [placeholder]=\"placeholder\" (blur)=\"_handleBlur($event)\"></div></div>",
        styles: ["md2-datepicker{position:relative;display:block;width:100%;outline:0;backface-visibility:hidden}md2-datepicker.md2-datepicker-disabled{pointer-events:none;cursor:default}.md2-datepicker-trigger{display:block;white-space:nowrap}.md2-datepicker-input{color:rgba(0,0,0,.38);display:flex;justify-content:space-between;align-items:center;height:2.3rem;width:100%;line-height:2.3rem;position:relative;box-sizing:border-box}[aria-disabled=true] .md2-datepicker-input{background-image:linear-gradient(to right,rgba(0,0,0,.26) 0,rgba(0,0,0,.26) 33%,transparent 0);background-size:4px 1px;background-repeat:repeat-x;border-color:transparent;background-position:0 bottom;cursor:default;user-select:none}.md2-datepicker-input.md2-datepicker-input-focused{color:#1592b1;border-color:#1592b1}md2-datepicker.ng-invalid.ng-touched:not(.md2-datepicker-disabled) .md2-datepicker-input{color:#f44336;border-color:#f44336}.md2-datepicker-value{position:relative;width:100%;white-space:nowrap;overflow-x:hidden;text-overflow:ellipsis;color:rgba(0,0,0,.87);border:0;outline:0;background:0 0}.md2-datepicker-disabled .md2-datepicker-value{color:rgba(0,0,0,.38)}[dir=rtl] .md2-datepicker-value{left:auto;right:0}.md2-calendar-years{position:absolute;top:10px;right:100%;bottom:10px;display:block;width:100%;line-height:40px;background:#fff;overflow-x:hidden;overflow-y:auto;transition:.3s}.md2-calendar-years.active{right:0}.md2-calendar-years .md2-calendar-years-content{display:flex;flex-direction:column;justify-content:center;min-height:100%}.md2-calendar-year{position:relative;display:block;margin:0 auto;padding:0;font-size:17px;font-weight:400;text-align:center;cursor:pointer}.md2-calendar-year.selected{color:#1592b1;font-size:26px;font-weight:500}.md2-datepicker-actions{text-align:right}.md2-datepicker-actions .md2-button{display:inline-block;min-width:64px;margin:4px 8px 8px 0;padding:0 12px;font-size:14px;color:#1592b1;line-height:36px;text-align:center;text-transform:uppercase;border-radius:2px;cursor:pointer;box-sizing:border-box;transition:all 450ms cubic-bezier(.23,1,.32,1)}.md2-datepicker-actions .md2-button:hover{background:#ebebeb} /*# sourceMappingURL=datepicker.css.map */ "],
...
__decorate$44([
    ...
    __metadata$25("design:type", Md2Datepicker)
], Md2DatepickerToggle.prototype, "datepicker", void 0);
Md2DatepickerToggle = __decorate$44([
...
Md2CalendarBody = __decorate$46([
    Component({selector: '[md2-calendar-body]',
        ...
        styles: [".md2-calendar-body{font-size:13px;min-width:224px}.md2-calendar-body-label{padding:7.14286% 0 7.14286% 7.14286%;height:0;line-height:0;color:rgba(0,0,0,.54);transform:translateX(-6px);text-align:left}.md2-calendar-body-cell{position:relative;width:14.28571%;height:0;line-height:0;padding:7.14286% 0;text-align:center;outline:0;cursor:pointer}.md2-calendar-body-disabled{cursor:default;pointer-events:none}.md2-calendar-body-cell-content{position:absolute;top:5%;left:5%;display:flex;align-items:center;justify-content:center;box-sizing:border-box;width:90%;height:90%;color:rgba(0,0,0,.87);border-width:1px;border-style:solid;border-color:transparent;border-radius:50%}.md2-calendar-body-disabled>.md2-calendar-body-cell-content:not(.md2-calendar-body-selected){color:rgba(0,0,0,.38)}.md2-calendar:focus .md2-calendar-body-active>.md2-calendar-body-cell-content:not(.md2-calendar-body-selected),:not(.md2-calendar-body-disabled):hover>.md2-calendar-body-cell-content:not(.md2-calendar-body-selected){background-color:rgba(0,0,0,.12)}.md2-calendar-body-selected{background-color:#1592b1;color:#fff}.md2-calendar-body-disabled>.md2-calendar-body-selected{background-color:rgba(21,146,177,.4)}.md2-calendar-body-today:not(.md2-calendar-body-selected){border-color:#1592b1}.md2-calendar-body-today.md2-calendar-body-selected{box-shadow:inset 0 0 0 1px md2-color(#1592b1,default-contrast)}.md2-calendar-body-disabled>.md2-calendar-body-today:not(.md2-calendar-body-selected){border-color:rgba(0,0,0,.18)}[dir=rtl] .md2-calendar-body-label{padding:0 7.14286% 0 0;transform:translateX(6px);text-align:right} /*# sourceMappingURL=calendar-body.css.map */ "],
        host: {
...
__decorate$45([
    Input(),
    __metadata$26("design:type", Date),
    __metadata$26("design:paramtypes", [Date])
...
Md2MonthView = __decorate$45([
    ...
    __param$8(2, Optional()), __param$8(2, Inject(MD_DATE_FORMATS)),
    __metadata$26("design:paramtypes", [DateLocale, DateUtil, Object])
], Md2MonthView);
...
Md2YearView = __decorate$47([
    ...
    __param$9(2, Optional()), __param$9(2, Inject(MD_DATE_FORMATS)),
    __metadata$28("design:paramtypes", [DateLocale, DateUtil, Object])
], Md2YearView);
...
__decorate$48([
    Input(),
    __metadata$29("design:type", Date),
    __metadata$29("design:paramtypes", [Date])
...
Md2Clock = __decorate$48([
    Component({selector: 'md2-clock',
        ...
        styles: [":host{position:relative;display:block;min-width:224px;margin:8px;font-size:14px;box-sizing:border-box;user-select:none}.md2-clock{position:relative;width:100%;height:0;padding-top:100%;background-color:#e0e0e0;border-radius:50%}.md2-clock-center{position:absolute;top:50%;left:50%;width:2%;height:2%;margin:-1%;border-radius:50%;background-color:#1592b1}.md2-clock-hand{position:absolute;top:0;right:0;bottom:0;left:0;width:1px;margin:0 auto;background-color:#1592b1;transform-origin:bottom}.md2-clock-hand::before{content:'';position:absolute;top:-4px;left:-4px;width:8px;height:8px;border-radius:50%;background-color:#1592b1}.md2-clock-hours,.md2-clock-minutes{position:absolute;top:0;left:0;width:100%;height:100%;opacity:0;visibility:hidden;transition:350ms;transform:scale(1.2)}.md2-clock-hours.active,.md2-clock-minutes.active{opacity:1;visibility:visible;transform:scale(1)}.md2-clock-minutes{transform:scale(.8)}.md2-clock-cell{position:absolute;display:flex;width:14.1666%;height:14.1666%;color:rgba(0,0,0,.87);justify-content:center;box-sizing:border-box;border-radius:50%;align-items:center;cursor:pointer}.md2-clock-cell:not(.md2-clock-cell-selected):not(.md2-clock-cell-disabled):hover{background-color:rgba(0,0,0,.1)}.md2-clock-cell.md2-clock-cell-disabled{color:rgba(0,0,0,.38);pointer-events:none}.md2-clock-cell.md2-clock-cell-selected{color:#fff;background-color:#18a5c8} /*# sourceMappingURL=clock.css.map */ "],
        host: {
            'role': 'clock',
...
Md2DatepickerModule = __decorate$40([
    NgModule({
        imports: [
            CommonModule,
            OverlayModule,
...
let Md2Optgroup = class Md2Optgroup extends _Md2OptgroupMixinBase {
    ...
    constructor() {
        super(...arguments);
        /** Unique id for the underlying label. */
        this._labelId = `md2-optgroup-label-${nextId$1++}`;
    }
};
__decorate$52([
    Input(),
...
Md2Option = __decorate$51([
    ...
    __metadata$31("design:paramtypes", [Md2Optgroup,
        ElementRef])
], Md2Option);
let Md2OptionModule = class Md2OptionModule {
};
Md2OptionModule = __decorate$51([
    NgModule({
...
__decorate$50([
    ...
    __metadata$30("design:type", QueryList)
...
__decorate$50([
    ...
    __metadata$30("design:paramtypes", [Number])
...
Md2Select = __decorate$50([
    ...
    __param$10(4, Optional()), __param$10(5, Self()), __param$10(5, Optional()),
    __param$10(6, Attribute('tabindex')),
    __metadata$30("design:paramtypes", [ElementRef, Renderer2,
